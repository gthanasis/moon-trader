...
import { BinanceSource, FearAndGreedSource, CryptoPanicSource } from '@trader/data'
import { candleRepository, signalRepository } from '@trader/db'

// pnpm runs scripts from the package dir; .env is two levels up at repo root
