...
- [x] Task 4: Cron wiring
- [x] Task 5: GET /narrations
- [x] Task 6: Backfill script
...
- [x] Task 10: dashboard components (PnlHero, NarrationPanel, LiveActivityFeed, SignalsSummary)
- [x] Task 11: assemble single-screen page.tsx
